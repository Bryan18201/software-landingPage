        ...
        <div className="container px-6 py-10 mx-auto">
            ...
            <div className="w-full space-y-12 lg:w-1/2 ">
              ...
              <div className="md:flex md:items-start md:-mx-4">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  <h1 className="text-xl font-semibold text-white capitaliz">
                    Responsive Design
                  </h1>

                  <p className="mt-3 text-gray-300/70 ">
              ...
              <div className="md:flex md:items-start md:-mx-4">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  <h1 className="text-xl font-semibold text-white capitalize :text-white">
                    Zero Configuration
                  </h1>
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
            <div className="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
              <svg
                className="h-12 text-gray-300/70 fill-current"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 266 100"
              >
            ...
            <div className="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
              <svg
                className="h-10 text-gray-300/70 fill-current"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
              <svg
                className="h-8 mt-2 text-gray-300/70 fill-current"
                viewBox="0 0 398 120"
                xmlns="http://www.w3.org/2000/svg"
              >
                <g fillRule="nonzero">
            ...
            <div className="flex items-center justify-center col-span-1 md:col-span-3 lg:col-span-1">
              <svg
                className="h-5 mt-1 text-gray-300/70 fill-current"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex items-center justify-center col-span-2 md:col-span-3 lg:col-span-1">
              <svg
                className="h-8 text-gray-300/70 fill-current"
